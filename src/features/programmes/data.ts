...
export const PROGRAMMES: Programme[] = [
  /* ---------------------------------------------------------------------- */
  {
    ...
    options: [
      "Upgrade to a 5★ riad and a premium camp",
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    guiding: GUIDING,
    hotels: "5★ riad or palace hotel, luxury mountain lodge, luxury desert camp",
    format: "6 days / 5 nights",
    days: 6,
    nights: 5,
    ...
    itinerary: [
      {
        ...
        place: "Marrakech",
        body: "Meet and assist at the airport and a private transfer to a 5★ riad. Dinner on a rooftop over the medina.",
        overnight: "Marrakech",
        imageKey: "b2-marrakech-medersa",
      },
      {
    ...
    includes: [
      "2 nights in a 5★ riad, 2 nights in a luxury lodge, 1 night in a luxury camp",
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    guiding: GUIDING,
    hotels: "4★ or 5★ hotel in Marrakech, private-use desert camp",
